	...
	<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Season Name', 'Total Expense','Total Income'],
           <?php
					...
					{
						echo "['".$row["sea_name"]."',".$row["(sum(weekly_bill)+sum(advance))"].",".$row["(sum(total_bill)+sum(paid))"]."],";
					}
			?>
        ]);

        var options = {
          title: 'Seasonal Budget and income report',
