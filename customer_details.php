...
<title><?php if (isset($_SESSION['com_name'])){echo $_SESSION['com_name'];};?> | Customer Details </title>
<!-- Bootstrap Core Css -->
                ...
                new shield.exp.OOXMLWorkbook({
                    ...
                    worksheets: [
					{
						...
						rows: [
						{
							...
							return {
								cells: [
								{ type: String, value: item.RECEIPT_NO },
								{ type: String, value: item.ORDER_DATE },
								{ type: String, value: item.PRODUCT_NAME },
								{ type: String, value: item.SEASON_NAME },
								{ type: String, value: item.QUANTITY },
								{ type: String, value: item.TOTAL_PRICE },
								{ type: String, value: item.AMOUNT_PAID },
								{ type: String, value: item.DUE },
								]
							};
						}))
					}
	...
	jQuery(function ($) {
        $("#pdf").click(function () {
            ...
            dataSource.read().then(function (data) {
				...
				{ field: "SEASON_NAME", title: "Season", width: 50 },
				{ field: "TOTAL_PRICE", title: "Price", width: 70 },
				{ field: "AMOUNT_PAID", title: "Paid", width: 70 },
				{ field: "DUE", title: "Due", width: 50 }
				],
				{
					margins: {
						top: 50,
