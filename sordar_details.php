...
<html>
	...
	<?php
		...
		$seaa_ID = $_SESSION['sea_id'];
		$sql = "SELECT pay_id FROM sordar_payment WHERE sor_id='$sor_ID' AND sea_id='$seaa_ID' ";
		$results=$conn->query($sql);
		$row = mysqli_fetch_assoc($results);
								...
								<form class="form-horizontal" method ="POST" >
									<div class="row clearfix">
										...
										<div class="col-lg-6 col-md-10 col-sm-8 col-xs-7">
											<div class="form-group">
												<div class="form-line">
													<input type="text" name="sname"  id="sname" class="form-control" value = "<?php if (isset($cn)) { echo $cn ;};?>" >
												</div>
											</div>
										</div>
									</div></br>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" align="center" id="largeModalLabel"><b>Insert Delivery Details Here</b> </h4><hr>
				</div>
