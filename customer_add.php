                                ...
                                <table style="font-size:15px;color:black;" id="exportTable"   class="table table-bordered table-striped table-hover ">
									...
									<?php
                                        ...
                                        <tr align ="center" >
                                            ...
                                            <td  <?php $o = $row['due']; if ($o==null){echo 'class="text-primary">No Entry';}elseif ($o==0){echo 'class="text-success">All due cleared';}else{echo "class='text-danger'><b> $o TK</b>";}?> </td>
                                            <td><b><?=$row['totalorder']?></b></td>
											<?php if($_SESSION['access']==(0)){?>
                               ...
                               <div class="modal-dialog modal-lg" role="document">
                                   <div class="modal-content">
                                       <div class="modal-header">
                                           <h4 class="modal-title" align="center" id="largeModalLabel"><b>Insert Customers Information Here</b> </h4><hr>
                                       </div>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-6 col-md-10 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" name="cus_name" oninput="validation()" id="cName" class="form-control" placeholder="Enter Customer name" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div></br>
